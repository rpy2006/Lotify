// Global songs array – this will be populated from songs.json
let songs = [];

// Fetch the songs details from songs.json and then initialize the player
fetch('music.js')
...
function renderPlaylist(container, songsList) {
